                            ...
                            <table id="range-search" class="display table table-hover" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        ?></td>
                                        <td class="text-center"><a href="include/process.php?employ_del=<?php echo $row['id'];?>" id="delete_btn" class="btn btn-sm btn-danger">Delete</a>
                                        </td>
                                    </tr>
                                    <?php
                                     }

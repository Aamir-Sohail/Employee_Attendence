        ...
        <div class="form-form">
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content mt-5 col-lg-12">

                        <h1 class="">Register To Dashboard</h1>
                        <p class="signup-link register">Already have an account? <a href="index.php">Log in</a></p>
                        <form class="text-left" method="POST" action="include/process.php">
                            <div class="form">

                                <div id="firstname-field" class="field-wrapper input">
                                    <label for="firstname">NAME</label>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                                    <input id="firstname" name="firstname" required type="text" class="form-control" placeholder="Username">
                                </div>
                                ...
                                <div id="email-field" class="field-wrapper input">
                                    ...
                                    <input id="email" name="email" type="text" value="" required class="form-control" placeholder="Enter Your Email">
                                </div>

                                <div id="address-field" class="field-wrapper input">
                                    <label for="address">ADDRESS</label>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-at-sign register"><circle cx="12" cy="12" r="4"></circle><path d="M16 8v5a3 3 0 0 0 6 0v-1a10 10 0 1 0-3.92 7.94"></path></svg>
                                    <input id="address" name="address" type="text" value="" required class="form-control" placeholder="Enter Your Address">
                                </div>

                                <div id="city-field" class="field-wrapper input">
                                    <label for="city">CITY</label>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-at-sign register"><circle cx="12" cy="12" r="4"></circle><path d="M16 8v5a3 3 0 0 0 6 0v-1a10 10 0 1 0-3.92 7.94"></path></svg>
                                    <input id="city" name="city" type="text" value="" required class="form-control" placeholder="Enter Your City Name">
                                </div>

                                <div id="city-field" class="field-wrapper input">
                                    <label for="phone">PHONE</label>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-at-sign register"><circle cx="12" cy="12" r="4"></circle><path d="M16 8v5a3 3 0 0 0 6 0v-1a10 10 0 1 0-3.92 7.94"></path></svg>
                                    <input id="phone" name="phone" type="number" min="11" max="" value="" required class="form-control" placeholder="Email">
                                </div>

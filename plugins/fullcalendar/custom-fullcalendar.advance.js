...
$(document).ready(function() {
    newData = fetch('http://localhost/employee_attendence/calender.php').then((resolve) => {return resolve.json()}).then((data)=>{return data[0];}).catch((error)=>{return ("some thing went wrong")});
    
    // fetch("http://localhost/employee_attendence/calender.php")
    ...
    //     req.open("GET","http://localhost/employee_attendence/calender.php", true);
    //     req.send();
    ...
    // $.ajax({
    //     url: "http://localhost/employee_attendence/calender.php",
    //     type: "post",
